...
namespace NBClassTest
{
    void test_NBClass_ConnectsNetworkSuccessfully(void)
    {
        ...
        TEST_ASSERT_EQUAL(NB_NETWORK_NOT_REGISTERED, BC95NB.begin(8));
        ...
        TEST_ASSERT_EQUAL(NB_NETWORK_SEARCHING_FOR_OPERATOR, BC95NB.begin(8));

        modemMock->setResponseStatus(MODEM_STATUS_VALID_RESPONSE);
        modemMock->setResponse("\r\n+CEREG:0,1\r\nOK\r\n");
        TEST_ASSERT_EQUAL(NB_NETWORK_REGISTERED, BC95NB.begin(8));
    }
